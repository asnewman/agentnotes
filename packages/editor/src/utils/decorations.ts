 ...
 */
function collectBoundaries(decorations: Decoration[], textLength: number): number[] {
 ...
 */
function getDecorationsInRange(
 ...
 */
export function mergeDecorations(decorations: Decoration[]): Decoration[] {
 ...
 */
export function isPositionDecorated(
  position: number,
  decorations: Decoration[],
 ...
 */
export function getDecorationsAtPosition(
  position: number,
  decorations: Decoration[]
): Decoration[] {
