...
export class Editor {
    ...
    `;
        ...
        this.keyboardHandler = new KeyboardHandler(this.editorRoot, this.callbacks, () => this.currentState);
        this.mouseHandler = new MouseHandler(this.editorRoot, this.callbacks, this.positionCalculator, () => this.focus());
     ...
     */
    injectStyles() {
        if (document.getElementById(`${CLASS_PREFIX}-styles`))
            return;
     ...
     */
    renderCursorAndSelection() {
        const textElement = this.textRenderer.getTextElement();
        // Render selection highlight
        this.selectionRenderer.render(this.currentState.selection, textElement, this.hasFocus);
        // Render cursor
